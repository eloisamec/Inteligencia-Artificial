...
public class Teste {
	...
	public static void main(String[] args) {
		...
		/*
		 * The second parameter for the addNode method is the identifier for the
		 * node's parent. In the case of the root node, either null is provided
		 * or no second parameter is provided.
		 */
		tree.addNode("Harry");
		tree.addNode("Jane", "Harry");
		tree.addNode("Bill", "Harry");
		tree.addNode("Joe", "Harry");
		...
		Iterator<Node> breadthIterator = tree.iterator("Harry",
